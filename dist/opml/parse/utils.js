import { isObject, parseArrayOf, parseBoolean, parseCsvOf, parseNumber, parseSingularOf, parseString, parseTextNumber, parseTextString, retrieveText, trimObject, } from '../../common/utils.js';
export const parseOutline = (value) => {
    if (!isObject(value)) {
        return;
    }
    return trimObject({
...
export const parsePrompts = (value) => {
    if (!isObject(value)) {
        return;
    }
    return trimObject({
...
export const parseHead = (value) => {
    ...
    return trimObject({
        ...
        expansionState: parseSingularOf(value.expansionstate, (value) => parseCsvOf(retrieveText(value), parseNumber)),
