import { createCaseInsensitiveGetter, isNonEmptyStringOrNumber, isObject, isPresent, parseArrayOf, parseBoolean, parseNumber, parseSingularOf, parseString, trimObject, } from '../../../common/utils.js';
...
export const retrieveAuthors = (value) => {
    if (!isObject(value)) {
        return;
    }
