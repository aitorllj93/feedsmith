import { isNonEmptyStringOrNumber, isObject, isPresent, parseArrayOf, parseBoolean, parseCsvOf, parseNumber, parseSingularOf, parseString, parseTextNumber, parseTextString, parseYesNoBoolean, retrieveText, trimObject, } from '../../common/utils.js';
...
export const retrieveItem = (value) => {
    ...
    const item = trimObject({
        duration: parseSingularOf(value['itunes:duration'], (value) => parseDuration(retrieveText(value))),
        image: parseSingularOf(value['itunes:image'], parseImage),
        explicit: parseSingularOf(value['itunes:explicit'], (value) => parseExplicit(retrieveText(value))),
        ...
        block: parseSingularOf(value['itunes:block'], (value) => parseYesNoBoolean(retrieveText(value))),
        ...
        keywords: parseSingularOf(value['itunes:keywords'], (value) => parseCsvOf(retrieveText(value), parseString)),
    });
    return item;
};
export const retrieveFeed = (value) => {
    ...
    const feed = trimObject({
        ...
        block: parseSingularOf(value['itunes:block'], (value) => parseYesNoBoolean(retrieveText(value))),
        complete: parseSingularOf(value['itunes:complete'], (value) => parseYesNoBoolean(retrieveText(value))),
